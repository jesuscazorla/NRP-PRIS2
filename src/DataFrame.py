...
class Dataframe(object):
    ...
    requirements = pd.DataFrame({'requirements': [['R0', 2, [Dependency.EXCLUSION.name,Dependency.NONE.name, Dependency.INCLUSION.name]], ['R1', 1, [Dependency.IMPLICACION.name, Dependency.NONE.name,Dependency.NONE.name]], ['R2', 3, [Dependency.NONE.name,Dependency.NONE.name, Dependency.NONE.name]]]})
